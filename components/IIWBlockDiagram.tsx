  ...
  return (
    <View style={{ marginBottom: 16 }}>
      <Svg width={W} height={H} viewBox={`0 0 ${VB_W} ${VB_H}`}>
        ...
        <Path d="M85,80 L295,80 A70,70 0 0 1 225,150 L85,150 Z" fill="#232A33" stroke="#3A4350" strokeWidth={1.2} />

        <Line x1={225} y1={80} x2={274} y2={129} stroke={amber} strokeWidth={2} />
        <Circle cx={225} cy={80} r={3} fill={amber} />

        <Polygon points="198,80 248,80 238,63 188,63" fill="#2E3640" stroke="#3A4350" strokeWidth={1} />
        <SvgText x={218} y={75} fill="#B7BFC9" fontFamily={mono} fontSize={9} textAnchor="middle">probe</SvgText>
